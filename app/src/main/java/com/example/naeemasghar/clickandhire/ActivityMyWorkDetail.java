...
public class ActivityMyWorkDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_my_work_detail);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new FragmentMyWorkDetail(), "Detail");
        adapter.addFrag(new FragmentMyWorkBids(), "Proposal");
