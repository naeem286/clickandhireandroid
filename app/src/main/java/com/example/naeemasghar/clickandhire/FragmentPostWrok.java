 ...
 */
public class FragmentPostWrok extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_post_work, container, false);
        ...
        recyclerView.addOnItemTouchListener(new FragmentDashboard.RecyclerTouchListener(getContext(), recyclerView, new FragmentDashboard.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(getActivity(), ActivitySubCategoryList.class);
