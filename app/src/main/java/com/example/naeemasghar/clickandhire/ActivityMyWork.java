...
public class ActivityMyWork extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity_my_work);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new FragmentMyPostWork(), "My Work");
        adapter.addFrag(new FragmentMyBids(), "My Bids");
